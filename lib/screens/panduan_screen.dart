...
class PanduanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Panduan Pengguna", style: TextStyle(fontWeight: FontWeight.bold)),
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: const Column(
              children: [
                Icon(Icons.help_outline_rounded, color: Colors.white, size: 50),
                SizedBox(height: 10),
                Text(
                  "Panduan Lengkap Aplikasi Anpundung",
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(15),
              border: Border.all(color: const Color(0xFFFFDC87), width: 1),
            ),
            child: Row(
              children: [
                const Icon(Icons.lightbulb_outline, color: Color(0xFFCC9C00), size: 24),
                const SizedBox(width: 12),
                Expanded(
                  child: Text(
                    "Masih punya pertanyaan? Hubungi admin melalui menu Bantuan",
                    style: TextStyle(
