...
class EdukasiScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Pojok Edukasi", style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text("Kenali Pungli!", style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
                      SizedBox(height: 5),
                      Text("Mari ciptakan Bandung bersih melayani tanpa korupsi.", style: TextStyle(color: Color(0xFFD6E4F0))),
                    ],
                  ),
                ),
              ...
              child: Theme(
                ...
                child: ExpansionTile(
                  leading: Container(
                    ...
                    decoration: BoxDecoration(color: const Color(0xFFD6E4F0), borderRadius: BorderRadius.circular(10)),
                    child: Icon(_getIcon(item['icon']!), color: const Color(0xFF163172)),
                  ),
                  title: Text(
                    item['title']!,
  ...
  // Fungsi helper buat milih ikon berdasarkan string
